                  ...
                  <div class="card-body">
                    <form action="{{url('kendaraan/'.$kendaraan->id)}}" method="POST">
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="basic-default-name" name="kendaraan" value="{{ $kendaraan->jenis_kendaraan }}"/>
                        </div>
                      </div>
                      <div class="row mb-3">
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="basic-default-name" name="tahun" value="{{ $kendaraan->tahun }}"/>
                        </div>
                      </div>
